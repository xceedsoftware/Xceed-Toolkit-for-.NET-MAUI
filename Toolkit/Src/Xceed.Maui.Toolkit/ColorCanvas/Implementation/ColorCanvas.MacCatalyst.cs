...
namespace Xceed.Maui.Toolkit
{
  public partial class ColorCanvas
  {
    ...
    partial void ApplyTemplateForPlatform( GraphicsView oldColorShadingCanvas, GraphicsView newColorShadingCanvas )
    {
      ...
      {
        oldColorShadingCanvas.GestureRecognizers.Remove( m_tapRecognizer );
        m_tapRecognizer.Tapped -= this.ColorShadingCanvas_Tapped;
      }
      ...
      if( newColorShadingCanvas != null )
      {
        ...
        m_tapRecognizer.Tapped += this.ColorShadingCanvas_Tapped;
        newColorShadingCanvas.GestureRecognizers.Add( m_tapRecognizer );
      }
    }

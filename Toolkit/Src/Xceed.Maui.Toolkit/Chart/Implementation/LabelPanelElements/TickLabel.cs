...
{
  internal class TickLabel : AreaElement
  {
    ...
    internal TickLabel( Orientation axisOrientation )
    {
    ...
    internal override void SetLocation( Rect bounds, Point offset )
    {
      this.Infos.Location = ( m_axisOrientation == Orientation.Horizontal )
                            ? new Point( offset.X - this.DesiredSize.Width / 2, 0 )
                            : new Point( bounds.Width - this.DesiredSize.Width, bounds.Bottom - offset.X - this.DesiredSize.Height / 2 );
    }
